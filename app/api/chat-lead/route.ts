        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#f5f5f5;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:32px;">
            ...
            <table style="width:100%;border-collapse:collapse;">
              <tr><td style="padding:10px 0;color:#a3a3a3;width:140px;">Name</td><td style="padding:10px 0;color:#fff;font-weight:600;">${name}</td></tr>
            ...
            <div style="margin-top:24px;">
              <a href="mailto:${email}" style="display:inline-block;padding:12px 24px;background:#dc2626;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;margin-right:12px;">Reply to ${name}</a>
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#f5f5f5;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:32px;">
            <h2 style="color:#fff;margin:0 0 12px;">Hey ${name}, we got your request! 🚀</h2>
            <p style="color:#a3a3a3;line-height:1.7;margin:0 0 16px;">
              ...
              <strong style="color:#ef4444;">${service}</strong> and our team will review it shortly.
            </p>
            ...
            <div style="background:#171717;border-radius:8px;padding:20px;margin-bottom:24px;">
              ...
              <table style="width:100%;border-collapse:collapse;">
                <tr><td style="padding:6px 0;color:#737373;font-size:13px;width:100px;">Name</td><td style="padding:6px 0;color:#f5f5f5;font-size:13px;">${name}</td></tr>
                <tr><td style="padding:6px 0;color:#737373;font-size:13px;">Email</td><td style="padding:6px 0;color:#f5f5f5;font-size:13px;">${email}</td></tr>
                ${phone ? `<tr><td style="padding:6px 0;color:#737373;font-size:13px;">Phone</td><td style="padding:6px 0;color:#f5f5f5;font-size:13px;">${phone}</td></tr>` : ''}
                <tr><td style="padding:6px 0;color:#737373;font-size:13px;">Service</td><td style="padding:6px 0;color:#ef4444;font-size:13px;font-weight:600;">${service}</td></tr>
              </table>
            </div>
          ...
          <div style="padding:20px 32px;background:#0f0f0f;text-align:center;">
            ...
            <p style="margin:0;color:#3f3f3f;font-size:11px;">
              You're receiving this because you started a chat at izzytechub.com
            </p>
          </div>
        </div>
      `,
